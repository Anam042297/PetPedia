             ...
             <div class="account-card-body">
                 <div class="row mb-3">
                     <div class="col text-end">
                         <a href="{{ route('products.create') }}" class="btn custom-btn" style="background-color: #ff99b6; border-color: #ff99b6; width: 15%; padding: 10px; border-radius: 5px; color: white; cursor: pointer; float: right; margin-top: -10px;">
 ...
 <script type="text/javascript">
     $(function () {
         var product_table = $('#product_table').DataTable({
             ...
             columns: [
                 { data: 'user.name', name: 'user.name' }, // Creator (user who added the product)
                 { data: 'name', name: 'name' }, // Product name
                 { data: 'category', name: 'category' },// Pet type: dog, cat, bird, etc.
                 { data: 'price', name: 'price' }, // Product price
                 { data: 'product_category', name: 'product_category' }, // Product category: food/accessory
                 { data: 'weight', name: 'weight', visible: true }, // Visible only for food products
                 { data: 'brand', name: 'brand' }, // Product brand
                 { data: 'stock', name: 'stock' }, // Product quantity
                 { data: 'images', name: 'images', orderable: false, searchable: false }, // Product images
