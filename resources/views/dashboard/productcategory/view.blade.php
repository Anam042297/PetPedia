        ...
        <div class="account-card-body">
            <div class="row mb-3">
                <div class="col text-end">
                    <a href="{{ route('ProductCategory.create') }}" style="background-color: #ff99b6;
...
<div class="container mt-5">
    <div class="account-card">
        ...
        <div class="account-card-body">
            <div class="row mb-3">
                <div class="col text-end">
                    <a href="{{ route('ProductCategory.create') }}" style="background-color: #ff99b6; border-color: #ff99b6; width: 15%; padding: 10px; border-radius: 5px; color: white; cursor: pointer; float: right; margin-top: -10px;" class="btn custom-btn">
