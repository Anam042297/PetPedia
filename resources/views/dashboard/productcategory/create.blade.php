        ...
        <div class="col-md-8 offset-md-2">
            <div class="account-card">
                ...
                <div class="account-card-body">
                    ...
                    <form id="contactForm" action="{{ isset($category) ? route('ProductCategory.update', $category->id) : route('ProductCategory.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (isset($category))
                            @method('PUT')
                        @endif
                        ...
                        @if (isset($category) && $category->icon)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $category->icon) }}" alt="Current Image" style="width: 100px; height: 100px;">
                            </div>
                        @endif
